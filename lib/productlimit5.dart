...
class productlimit extends StatefulWidget {
  const productlimit({Key? key}) : super(key: key);
...
class _productlimitState extends State<productlimit> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Product Limit 5"), backgroundColor: Colors.black),
      body: WillPopScope(
        onWillPop: onback,
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(text: "${list[index].title}",style: TextStyle(
                              ...
                              RichText(
                                  text: TextSpan(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold),
                                      children: [
                                        TextSpan(text:"${list[index].price.toString()}",style: TextStyle(
                                            color: Colors.black54,
                                            fontWeight: FontWeight.bold
                                        ),)
                                      ])),
                              RichText(
                                  text: TextSpan(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold),
                                      children: [
                                        TextSpan(text: "${list[index].description}",style: TextStyle(
                                            color: Colors.black54,
                                            fontWeight: FontWeight.bold
                                        ),)
                                      ])),
                              RichText(
                                  text: TextSpan(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold),
                                      children: [
                                        TextSpan(text: "${list[index].category}",style: TextStyle(
                                            color: Colors.black54,
                                            fontWeight: FontWeight.bold
                                        ),)
                                      ])),
                              ...
                              RichText(
                                  text: TextSpan(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold),
                                      children: [
                                        TextSpan(text: "${list[index].rating!.rate}",style: TextStyle(
                                            color: Colors.black54,
                                            fontWeight: FontWeight.bold
                                        ),)
                                      ])),
                              RichText(
                                  text: TextSpan(
                                      ...
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold),
                                      children: [
                                        TextSpan(text:"${list[index].rating!.count}",style: TextStyle(
                                            color: Colors.black54,
                                            fontWeight: FontWeight.bold
                                        ),)
                                      ])),
